...
var EstimateResponse = /*#__PURE__*/function () {
  function EstimateResponse(success, error, data) {
    _classCallCheck(this, EstimateResponse);

    EstimateResponse.initialize(this, success, error, data);
  }

  _createClass(EstimateResponse, null, [{
    key: "initialize",
