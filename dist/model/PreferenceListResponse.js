...
var PreferenceListResponse = /*#__PURE__*/function () {
  function PreferenceListResponse(success, error, data, meta) {
    _classCallCheck(this, PreferenceListResponse);

    PreferenceListResponse.initialize(this, success, error, data, meta);
  }

  _createClass(PreferenceListResponse, null, [{
    key: "initialize",
