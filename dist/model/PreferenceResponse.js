...
var PreferenceResponse = /*#__PURE__*/function () {
  function PreferenceResponse(success, error, data) {
    _classCallCheck(this, PreferenceResponse);

    PreferenceResponse.initialize(this, success, error, data);
  }

  _createClass(PreferenceResponse, null, [{
    key: "initialize",
