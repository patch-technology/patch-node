...
var EstimateListResponse = /*#__PURE__*/function () {
  function EstimateListResponse(success, error, data, meta) {
    _classCallCheck(this, EstimateListResponse);

    EstimateListResponse.initialize(this, success, error, data, meta);
  }

  _createClass(EstimateListResponse, null, [{
    key: "initialize",
