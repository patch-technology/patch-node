    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('transaction_value_eth_gwei')) {
                obj['transaction_value_eth_gwei'] = ApiClient.convertToType(data['transaction_value_eth_gwei'], 'Number');
            }
            
            if (data.hasOwnProperty('average_daily_balance_eth_gwei')) {
                obj['average_daily_balance_eth_gwei'] = ApiClient.convertToType(data['average_daily_balance_eth_gwei'], 'Number');
            }
...
CreateEthereumEstimateRequest.prototype['transaction_value_eth_gwei'] = undefined;

CreateEthereumEstimateRequest.prototype['average_daily_balance_eth_gwei'] = undefined;
