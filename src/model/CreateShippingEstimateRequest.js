...
class CreateShippingEstimateRequest {
    constructor(distanceM, packageMassG, transportationMethod) { 
        ...
        CreateShippingEstimateRequest.initialize(this, distanceM, packageMassG, transportationMethod);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('distance_m')) {
                obj['distance_m'] = ApiClient.convertToType(data['distance_m'], 'Number');
            }
            
            if (data.hasOwnProperty('package_mass_g')) {
                obj['package_mass_g'] = ApiClient.convertToType(data['package_mass_g'], 'Number');
            }
            
            if (data.hasOwnProperty('transportation_method')) {
                obj['transportation_method'] = ApiClient.convertToType(data['transportation_method'], 'String');
            }
