...
class Order {
    constructor(id, massG, production, state, allocationState, priceCentsUsd, patchFeeCentsUsd, metadata) { 
        
        Order.initialize(this, id, massG, production, state, allocationState, priceCentsUsd, patchFeeCentsUsd, metadata);
    }

    static initialize(obj, id, massG, production, state, allocationState, priceCentsUsd, patchFeeCentsUsd, metadata) { 
        obj['id'] = id;
        obj['mass_g'] = massG;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('allocation_state')) {
                obj['allocation_state'] = ApiClient.convertToType(data['allocation_state'], 'String');
            }
            
            if (data.hasOwnProperty('price_cents_usd')) {
                obj['price_cents_usd'] = ApiClient.convertToType(data['price_cents_usd'], 'Number');
            }
            
            if (data.hasOwnProperty('patch_fee_cents_usd')) {
                obj['patch_fee_cents_usd'] = ApiClient.convertToType(data['patch_fee_cents_usd'], 'Number');
            }
