...
import Highlight from './Highlight';import Photo from './Photo';import Sdg from './Sdg';import Standard from './Standard';import TechnologyType from './TechnologyType';

class Project {
    constructor(id, production, name, description, country, developer, averagePricePerTonneCentsUsd, remainingMassG, technologyType, highlights) { 
        
        Project.initialize(this, id, production, name, description, country, developer, averagePricePerTonneCentsUsd, remainingMassG, technologyType, highlights);
    }

    static initialize(obj, id, production, name, description, country, developer, averagePricePerTonneCentsUsd, remainingMassG, technologyType, highlights) { 
        obj['id'] = id;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('average_price_per_tonne_cents_usd')) {
                obj['average_price_per_tonne_cents_usd'] = ApiClient.convertToType(data['average_price_per_tonne_cents_usd'], 'Number');
            }
            
            if (data.hasOwnProperty('remaining_mass_g')) {
                obj['remaining_mass_g'] = ApiClient.convertToType(data['remaining_mass_g'], 'Number');
            }
            ...
            if (data.hasOwnProperty('technology_type')) {
                obj['technology_type'] = TechnologyType.constructFromObject(data['technology_type']);
            }
            
            if (data.hasOwnProperty('highlights')) {
                obj['highlights'] = ApiClient.convertToType(data['highlights'], [Highlight]);
            }
