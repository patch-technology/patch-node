...
export default class EstimatesApi {
  ...
  createBitcoinEstimateWithHttpInfo(createBitcoinEstimateRequest) {
      ...
      const _createBitcoinEstimateRequest = CreateBitcoinEstimateRequest.constructFromObject(createBitcoinEstimateRequest, new CreateBitcoinEstimateRequest())
      let postBody = _createBitcoinEstimateRequest;


      // verify the required parameter 'createBitcoinEstimateRequest' is set
      if (_createBitcoinEstimateRequest === undefined || _createBitcoinEstimateRequest === null) {
        throw new Error("Missing the required parameter 'createBitcoinEstimateRequest' when calling createBitcoinEstimate");
      }
  ...
  createEthereumEstimateWithHttpInfo(createEthereumEstimateRequest) {
      ...
      const _createEthereumEstimateRequest = CreateEthereumEstimateRequest.constructFromObject(createEthereumEstimateRequest, new CreateEthereumEstimateRequest())
      let postBody = _createEthereumEstimateRequest;


      // verify the required parameter 'createEthereumEstimateRequest' is set
      if (_createEthereumEstimateRequest === undefined || _createEthereumEstimateRequest === null) {
        throw new Error("Missing the required parameter 'createEthereumEstimateRequest' when calling createEthereumEstimate");
      }
    ...
    createEthereumEstimate(createEthereumEstimateRequest) {
      return this.createEthereumEstimateWithHttpInfo(createEthereumEstimateRequest)
    }


  createFlightEstimateWithHttpInfo(createFlightEstimateRequest) {
      
      const _createFlightEstimateRequest = CreateFlightEstimateRequest.constructFromObject(createFlightEstimateRequest, new CreateFlightEstimateRequest())
      let postBody = _createFlightEstimateRequest;


      // verify the required parameter 'createFlightEstimateRequest' is set
      if (_createFlightEstimateRequest === undefined || _createFlightEstimateRequest === null) {
        throw new Error("Missing the required parameter 'createFlightEstimateRequest' when calling createFlightEstimate");
      }
  ...
  createHotelEstimateWithHttpInfo(createHotelEstimateRequest) {
      ...
      const _createHotelEstimateRequest = CreateHotelEstimateRequest.constructFromObject(createHotelEstimateRequest, new CreateHotelEstimateRequest())
      let postBody = _createHotelEstimateRequest;


      // verify the required parameter 'createHotelEstimateRequest' is set
      if (_createHotelEstimateRequest === undefined || _createHotelEstimateRequest === null) {
        throw new Error("Missing the required parameter 'createHotelEstimateRequest' when calling createHotelEstimate");
      }
  ...
  createMassEstimateWithHttpInfo(createMassEstimateRequest) {
      ...
      const _createMassEstimateRequest = CreateMassEstimateRequest.constructFromObject(createMassEstimateRequest, new CreateMassEstimateRequest())
      let postBody = _createMassEstimateRequest;


      // verify the required parameter 'createMassEstimateRequest' is set
      if (_createMassEstimateRequest === undefined || _createMassEstimateRequest === null) {
  ...
  createShippingEstimateWithHttpInfo(createShippingEstimateRequest) {
      ...
      const _createShippingEstimateRequest = CreateShippingEstimateRequest.constructFromObject(createShippingEstimateRequest, new CreateShippingEstimateRequest())
      let postBody = _createShippingEstimateRequest;


      // verify the required parameter 'createShippingEstimateRequest' is set
      if (_createShippingEstimateRequest === undefined || _createShippingEstimateRequest === null) {
        throw new Error("Missing the required parameter 'createShippingEstimateRequest' when calling createShippingEstimate");
      }
    ...
    createShippingEstimate(createShippingEstimateRequest) {
      return this.createShippingEstimateWithHttpInfo(createShippingEstimateRequest)
    }


  createVehicleEstimateWithHttpInfo(createVehicleEstimateRequest) {
      
      const _createVehicleEstimateRequest = CreateVehicleEstimateRequest.constructFromObject(createVehicleEstimateRequest, new CreateVehicleEstimateRequest())
      let postBody = _createVehicleEstimateRequest;


      // verify the required parameter 'createVehicleEstimateRequest' is set
      if (_createVehicleEstimateRequest === undefined || _createVehicleEstimateRequest === null) {
        throw new Error("Missing the required parameter 'createVehicleEstimateRequest' when calling createVehicleEstimate");
      }
